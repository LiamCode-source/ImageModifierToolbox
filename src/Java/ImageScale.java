 ...
 */
public class ImageScale extends CustomJavaAction<java.lang.Boolean>
{
	private IMendixObject __OriginalImage;
	private system.proxies.Image OriginalImage;
	private java.math.BigDecimal xScale;
	private java.math.BigDecimal yScale;

	public ImageScale(IContext context, IMendixObject OriginalImage, java.math.BigDecimal xScale, java.math.BigDecimal yScale)
	{
		super(context);
		...
		if (!extension.equals("jpg") && !extension.contentEquals("jpeg") && !extension.contentEquals("png")) {
			...
			if (__OriginalImage == null) {
				...
				try {
					...
					if (xScale == null) {xScale = new BigDecimal("1");}
					if (yScale == null) {yScale = new BigDecimal("1");}
						
					scaledImage = scaleTransform(image, xScale.floatValue(), yScale.floatValue());
	...
	// BEGIN EXTRA CODE
		public BufferedImage scaleTransform(BufferedImage image, float xScale, float yScale) {
